...
mongoose
  .connect(
    `mongodb+srv://${process.env.MongoDB_User}:${process.env.MongoDB_Password}@${process.env.MongoDB_Cluster}.lvigw.mongodb.net/${process.env.MongoDB_Database}?retryWrites=true&w=majority`,
    {
